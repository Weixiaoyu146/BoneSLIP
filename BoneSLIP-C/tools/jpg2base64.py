...
def txt_generate2(labels, body_parts, begin, strategy, output_path):
...
def txt_generate3(labels, body_parts, begin, strategy, output_path, textitem):
...
if __name__ == "__main__":
    ...
    #
    strategy = 'valid' #输出策略：all/train/test/valid
    ...
    data_path = r"/hdd3/hdd/hdd2/wxy/dataset/CLIP/Chinese_CLIP/mianyang+huaxi/" + strategy + '/'

    output_path = r'/hdd3/hdd/hdd2/wxy/dataset/CLIP/Chinese_CLIP/clip4.0/' + strategy
    ...
    for body_path in glob.glob(data_path + "*"):
        ...
        for label_path in glob.glob(body_path + "/*"):
            ...
            for file_name in glob.glob(label_path + "/*"):
                ...
                txt_generate3(labels, body_part, begin, strategy, output_path, textitem)
