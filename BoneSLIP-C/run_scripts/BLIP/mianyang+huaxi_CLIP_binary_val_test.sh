...
datapath=${path}/binary_test
savedir=/hdd/wxy/models/chinese_CLIP/val_result/mianyang+huaxi_origin_binary
...
#label_file=${path}/label_origin/binary_label_cn.txt
label_file=${path}/binary_label_cn.txt
index=${7:-}
