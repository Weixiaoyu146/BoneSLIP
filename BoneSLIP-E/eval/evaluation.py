...
if __name__ == "__main__":
    ...
    standard_path = r'/hdd3/hdd/hdd2/cbh/datasets/OpenClip/CLIP4.0/test/test_texts.jsonl'
    # the path of prediction file (eg. example_pred.jsonl)
    submit_path = r'/hdd3/hdd/hdd2/cbh/datasets/OpenClip/CLIP4.0/eval_CLIP/predictions.jsonl'
    # the score will be dumped into this output json file
    out_path = r'/hdd3/hdd/hdd2/cbh/datasets/OpenClip/CLIP4.0/eval_CLIP/recall_scores.jsonl'
